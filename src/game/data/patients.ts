...
export const PATIENT_TEMPLATES: PatientTemplate[] = [
  ...
  },
  {
    ...
    severity: 2,
    bestTechniques: ['mouth_wash', 'herbal_draught', 'poultice'],
    basePay: 12,
  ...
  },
  {
    ...
    dominantHumor: 'yellowBile',
    severity: 2,
    bestTechniques: ['mouth_wash', 'poultice', 'bath_wash'],
    basePay: 14,
  ...
  },
  {
    ...
    dominantHumor: 'yellowBile',
    severity: 3,
    bestTechniques: ['herbal_draught', 'poultice', 'purge_draught'],
    basePay: 12,
    portraitKey: 'port_sick',
    weight: 1.0,
  },
  ...
  },
  {
    ...
    dominantHumor: 'blood',
    severity: 3,
    bestTechniques: ['poultice', 'herbal_draught', 'bath_wash'],
    basePay: 8,
    portraitKey: 'port_youth',
    weight: 1.0,
  },
  ...
  },
  {
    ...
    dominantHumor: 'blood',
    severity: 3,
    bestTechniques: ['wound_dress', 'poultice', 'bath_wash'],
    basePay: 22,
    portraitKey: 'port_artisan',
    weight: 0.9,
  },
  ...
  },
  {
    ...
    dominantHumor: 'blackBile',
    severity: 2,
    bestTechniques: ['bath_wash', 'poultice', 'sweat_bath'],
    basePay: 5,
    portraitKey: 'port_sick',
    weight: 1.3,
  },
  ...
  },
  {
    ...
    dominantHumor: 'blood',
    severity: 4,
    bestTechniques: ['bloodletting', 'poultice', 'herbal_draught'],
    basePay: 22,
    portraitKey: 'port_sick',
    weight: 0.7,
  },
  ...
  },
  {
    ...
    dominantHumor: 'phlegm',
    severity: 4,
    bestTechniques: ['herbal_draught', 'poultice', 'bath_wash'],
    basePay: 18,
    portraitKey: 'port_woman',
    weight: 0.5,
  },
  {
    // The old data id is retained in bloodletting maps for save-adjacent
    // compatibility; the visible complaint never asserts post-1495 syphilis.
    id: 'venereal_ulcer',
    class: 'soldier',
    complaintKey: 'complaint.foul_ulcer',
    dominantHumor: 'yellowBile',
    severity: 3,
    bestTechniques: ['cauterize', 'poultice', 'wound_dress'],
    basePay: 25,
    portraitKey: 'port_soldier',
    weight: 0.5,
  },
